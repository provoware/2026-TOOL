...
printf '\n[4/9] Python-Syntax\n'; python3 -m py_compile \
  ...
  tests/test_shell.py tests/test_data_core.py tests/test_api_contract.py tests/test_self_repair.py tests/test_agent_gate.py tests/test_ux_contract.py tests/test_backup_snapshots.py
