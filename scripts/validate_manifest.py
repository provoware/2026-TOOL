...
app = m.get("app", {})
if app.get("version") != "0.2.1": errors.append("Basis-App-Version muss bis zur Promotion 0.2.1 sein")
iteration = m.get("iteration", {})
if iteration.get("number") != 2: errors.append("Iteration muss 2 sein")
if iteration.get("stage") != "2.2": errors.append("Iterationsstufe muss 2.2 sein")
if iteration.get("base_release") != "0.2.1": errors.append("Basisrelease muss 0.2.1 sein")
if iteration.get("candidate_release") != "0.2.2": errors.append("Kandidatenrelease muss 0.2.2 sein")
ui = m.get("ui", {})
...
zoom = ui.get("zoom_percent", {})
if zoom != {"min": 100, "max": 200, "step": 5}: errors.append("Zoomvertrag muss 100–200 % in 5er Schritten sein")
required_shortcuts = {"Ctrl++", "Ctrl+-", "Ctrl+0", "Ctrl+Mausrad"}
if set(ui.get("zoom_shortcuts", [])) != required_shortcuts: errors.append("Zoom-Tastaturvertrag unvollständig")
...
if errors:
    ...
    raise SystemExit(1)
print("OK   Manifest konsistent – UX/Feedback Kandidat für v0.2.2")
