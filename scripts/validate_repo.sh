...
required=(
  ...
  docs/ARCHITEKTUR.md docs/QUALITAETSSICHERUNG.md docs/STARTROUTINE.md docs/AGENTEN_WORKFLOW.md docs/HILFE.md docs/SELFREPAIR.md
...
printf '\nRepository-Struktur vollständig – Reliability/Self-Repair v0.2.1.\n'
