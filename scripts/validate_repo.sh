...
required=(
  ...
  docs/iterationen/ITERATION_02_PLAN.md docs/iterationen/ITERATION_021_PLAN.md docs/iterationen/ITERATION_022_UX_PLAN.md docs/iterationen/HOTFIX_BACKUP_ROTATION.md
  ...
  tests/README.md tests/test_shell.py tests/test_data_core.py tests/test_api_contract.py tests/test_self_repair.py tests/test_agent_gate.py tests/test_ux_contract.py tests/test_backup_workflow.py
)
missing=0
...
printf '\nRepository-Struktur vollständig – inklusive Backup-Rotationsvertrag.\n'
