...
required=(
  ...
  docs/ARCHITEKTUR.md docs/QUALITAETSSICHERUNG.md docs/STARTROUTINE.md docs/AGENTEN_WORKFLOW.md docs/HILFE.md docs/SELFREPAIR.md docs/UX_STANDARD.md
  docs/iterationen/ITERATION_02_PLAN.md docs/iterationen/ITERATION_021_PLAN.md docs/iterationen/ITERATION_022_UX_PLAN.md docs/iterationen/ITERATION_023_BACKUP_HOTFIX.md
  ...
  tests/README.md tests/test_shell.py tests/test_data_core.py tests/test_api_contract.py tests/test_self_repair.py tests/test_agent_gate.py tests/test_ux_contract.py tests/test_backup_snapshots.py
)
missing=0
...
printf '\nRepository-Struktur vollständig – Backup-Reliability-Hotfix v0.2.3.\n'
