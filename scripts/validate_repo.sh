...
required=(
  ...
  tests/README.md tests/test_shell.py tests/test_data_core.py tests/test_api_contract.py tests/test_self_repair.py tests/test_agent_gate.py tests/test_ux_contract.py
)
missing=0
...
printf '\nRepository-Struktur vollständig – UX/Feedback-Iteration vorbereitet.\n'
